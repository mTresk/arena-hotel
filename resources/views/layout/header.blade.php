        ...
        <div class="top-header__container">
            <div class="top-header__body">
                ...
                <div data-da=".menu__body,850,3" class="top-header__right">
                    ...
                    <button type="button" class="top-header__callback">
                        <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="bottom-header__left">
                    ...
                    <div class="bottom-header__menu menu">
                        <nav class="menu__body">
                            <a href="/" class="menu__main">Главная</a>
                            <ul class="menu__list">
                                <li class="menu__item"><a href="rooms.html" class="menu__link">Номера и цены</a></li>
